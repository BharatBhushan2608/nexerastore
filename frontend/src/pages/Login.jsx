        ...
        const submitHandler = async(e) => {
            ...
            try {
                ...
                if(res.data.success){
                    ...
                    localStorage.setItem("accessToken", res.data.accessToken) ; // setting access token in local storage
     ...
     <div className='flex justify-center items-center min-h-screen bg-pink-100'>
            <Card className="w-full max-w-sm">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className='relative'>
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        type={showPassword ? "text" : "password"} // agr showPassword true hoga to text dikhayega warna password dikhayega
                                        required
                                    />
                ...
                <CardFooter className="flex-col gap-2">
                    ...
                    <p className='text-gray-700 text-sm '>Don't have an account? <Link to={"/signup"} className='hover:underline hover:text-pink-900 cursor-pointer '>signup</Link></p>
