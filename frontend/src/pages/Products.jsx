...
//     try {
//       setLoading(true)
//       const res = await axios.get(`${import.meta.env.VITE_URL}/api/v1/product/getallproduct`)
//       if (res.data.success) {
...
//   return (
//     <div className='pt-20 pb-10 pr-30'>
...
return ( <div className='pt-20 pb-10 px-4 md:px-6 lg:px-10'>
